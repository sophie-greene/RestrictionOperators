    ...
    class Program
    {
        ...
        public class LinqSamples
        {
            ...
            public void Linq3()
            {
                ...
                //TODO: Create code to implement the functionality 
                //listed in the [Description] tag for this query
                var expensiveInStockProducts = from prod in products
                                               where prod.UnitsInStock>0 && prod.UnitPrice > new Decimal(3.0)  
                                               select prod;
            ...
            public void Linq4()
            {
                ...
                var waCustomers = from cust in customers
                                               where cust.Region=="WA" ||cust.Region == "Washington"
                                  select cust;
